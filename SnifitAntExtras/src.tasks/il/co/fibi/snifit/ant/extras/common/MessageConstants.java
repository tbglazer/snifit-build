...
public class MessageConstants {
	...
	public static final String COMMON_MISSING_PROJECT_NAME_FROM_REFERENCE = "Common.missingProjectNameFromReference";
	...
	public static final String COMMON_EXPORTING_PROJECT = "Common.exportingProject";

	public static final String COMMON_REFRESHING_PROJECT = "Common.refreshingProject";

	public static final String COMMON_IMPORTING_FILE = "Common.importingFile";

	public static final String COMMON_BUILDING_PROJECT = "Common.buildingProject";

	public static final String COMMON_BUILDING_WORKSPACE = "Common.buildingWorkspace";
	...
	public static final String ANT_CONSOLE_TASK_JOB_START = "AntConsoleProgressMonitor.jobStart";

	public static final String ANT_CONSOLE_TASK_JOB_END = "AntConsoleProgressMonitor.jobEnd";

	public static final String ANT_CONSOLE_TASK_JOB_SUB_TASK = "AntConsoleProgressMonitor.jobSubTask";
	...
	public static final String WORKSPACE_PREFERENCE_SET_MISSING_TYPE = "WorkspacePreferenceSet.missingPreferenceType";
	...
	public static final String BUILD_APPLICATION_UTIL_ADD_JAR_TO_EAR = "BuildApplicationUtilJar.addJarToEar";
	...
	public static final String EAR_IMPORT_NO_RUNTIME_TYPE_FOUND = "EARImport.missingRuntime";
	...
	public static final String PREPARE_FOR_DEPLOYMENT_EXECUTE = "PrepareForDeployment.execute";
	...
	public static final String XML_CATALOG_MALFORMED_URI = "XMLCatalog.malformedURI";

	public static final String XML_CATALOG_INVALID_FILE = "XMLCatalog.invalidFile";
