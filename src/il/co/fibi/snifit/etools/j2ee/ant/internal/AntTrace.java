...
public class AntTrace extends InternalTrace {
  ...
  protected void updateOptions(DebugOptions options) {
    ROOT_TRACE_ENABLED = options.getBooleanOption("com.ibm.etools.j2ee.ant/debug", 
        false);
    SERVER_TRACE_ENABLED = options.getBooleanOption("com.ibm.etools.j2ee.ant/debug/antserver", 
        false);
    J2EE_TRACE_ENABLED = options.getBooleanOption("com.ibm.etools.j2ee.ant/debug/antj2ee", 
        false);
    EXTRAS_TRACE_ENABLED = options.getBooleanOption("com.ibm.etools.j2ee.ant/debug/antextras", 
        false);
  }
