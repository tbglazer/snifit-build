...
public class CaptureBuildMessages extends FailOnErrorTask {
  ...
  public void execute() throws BuildException {
    ...
    try {
      getProject().log(
          ResourceHandler.getString("CaptureBuildMessages.startupMessage", (Object[])new String[] { this.action, this.searchString }), 4);
  ...
  protected void validateAttributes(IProgressMonitor monitor) throws BuildException {
    ...
    if (this.action == null) {
      ...
      if (this.searchString == null)
        handleError(ResourceHandler.getString(
              "CaptureBuildMessages.invalidSearchString", "findMessages")); 
      ...
      if (this.searchString == null)
        handleError(ResourceHandler.getString(
              "CaptureBuildMessages.invalidSearchString", "failonerrormessagepresent")); 
      if (this.searchContext == null)
        this.searchContext = this.DEFAULTsearchContext; 
    } else if (this.action.equalsIgnoreCase("failOnErrorMessageMissing")) {
      ...
      if (this.searchString == null)
        handleError(ResourceHandler.getString(
              "CaptureBuildMessages.invalidSearchString", "failonerrormessagemissing")); 
      if (this.searchContext == null)
        this.searchContext = this.DEFAULTsearchContext; 
    } else {
      handleError(
          ResourceHandler.getString("CaptureBuildMessages.invalidAction", this.action));
    } 
    if (this.messageLevel.equalsIgnoreCase("error")) {
      ...
      handleError(
          ResourceHandler.getString("CaptureBuildMessages.invalidMessageLevel", this.messageLevel));
    } 
  }
}
