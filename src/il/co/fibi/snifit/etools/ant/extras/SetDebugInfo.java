...
public class SetDebugInfo extends FailOnErrorTask {
  ...
  public void setDebugOptions() {
    ...
    String DebugInfoMsg = ResourceHandler.getString("SetDebugInfo.debugInfo", (Object[])new String[] { variables, lines, source });
  ...
  protected void validateAttributes(IProgressMonitor monitor) throws BuildException {
    ...
    if (this.debugInfo != null && 
      !this.debugInfo.equalsIgnoreCase("true") && !this.debugInfo.equalsIgnoreCase("false")) {
      handleError(
          ResourceHandler.getString("SetDebugInfo.invalidDebugInfo", this.debugInfo));
      return;
    } 
    if (this.localVariable != null && !this.localVariable.equalsIgnoreCase("true") && 
      !this.localVariable.equalsIgnoreCase("false")) {
      handleError(
          ResourceHandler.getString("SetDebugInfo.invalidVariableSymbol", this.localVariable));
      return;
    } 
    if (this.lineNumber != null && 
      !this.lineNumber.equalsIgnoreCase("true") && !this.lineNumber.equalsIgnoreCase("false")) {
      handleError(
          ResourceHandler.getString("SetDebugInfo.invalidLineNumber", this.lineNumber));
      return;
    } 
    if (this.sourceFile != null && 
      !this.sourceFile.equalsIgnoreCase("true") && !this.sourceFile.equalsIgnoreCase("false")) {
      handleError(
          ResourceHandler.getString("SetDebugInfo.invalidSourceFile", this.sourceFile));
      return;
    } 
  }
}
